package com.xz.greendao_xz.slideview;
...
import com.xz.greendao_xz.view.CheckableFrameLayout;


public class SwipeMenuLayout extends CheckableFrameLayout {
	...
	private void init() {
		...
		mMenuView.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,
				FrameLayout.LayoutParams.WRAP_CONTENT));
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mMenuView.measure(View.MeasureSpec.makeMeasureSpec(0,
